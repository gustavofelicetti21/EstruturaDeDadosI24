...
Hashtable phoneBook = new Hashtable()
{
    ...
    {"Gabriel Bianchi", "49-99015-8904"}
};

// É possível adicoinar elementos de diversas formas, Pelo próprio índice chave inexistente
phoneBook["Thiago Padilha"] = "49-99176-8255";

// Ou pelo método Add()
phoneBook.Add("Marcos Henrique", "49-99202-6169");

// Entretanto, a TabelaHash verificca se há duplicidade de chave e pode lançar uma Exception
try
{
